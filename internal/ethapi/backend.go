...
// Package ethapi implements the general DipNet API functions.
package ethapi
...
type Backend interface {
	// General DipNet API
	SyncProgress(ctx context.Context) dipnet.SyncProgress
...
func GetAPIs(apiBackend Backend) []rpc.API {
	...
	return []rpc.API{
		{
			Namespace: "eth",
			Service:   NewDipNetAPI(apiBackend),
		}, {
			Namespace: "eth",
			...
			Namespace: "eth",
			Service:   NewDipNetAccountAPI(apiBackend.AccountManager()),
		},
	}
}
