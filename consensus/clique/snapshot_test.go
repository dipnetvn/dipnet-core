...
// mapped from textual names used in the tests below to actual DipNet private
...
// address retrieves the DipNet address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the DipNet address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/dipnetvn/dipnet-core/issues/17593). Whilst this
