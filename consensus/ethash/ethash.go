...
// all blocks' seal as valid, though they still have to conform to the DipNet
// consensus rules.
...
// still have to conform to the DipNet consensus rules.
...
// they still have to conform to the DipNet consensus rules.
