...
// https://github.com/dipnet/EIPs/blob/master/EIPS/eip-3675.md
//
...
// rules of the DipNet consensus engine.
...
// verifyHeader checks whether a header conforms to the consensus rules of the
// stock DipNet consensus engine. The difference between the beacon and classic is
