...
import "github.com/dipnetvn/dipnet-core/common"

// MainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main DipNet network.
var MainnetBootnodes = []string{
	// DipNet Foundation Go Bootnodes
...
// genesis hash and protocol. See https://github.com/dipnet/discv4-dns-lists for more
// information.
