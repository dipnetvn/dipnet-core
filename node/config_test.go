...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "dipnet.ipc", false, filepath.Join(os.TempDir(), "dipnet.ipc")},
		{"data", "dipnet.ipc", false, "data/dipnet.ipc"},
		{"data", "./dipnet.ipc", false, "./dipnet.ipc"},
		{"data", "/dipnet.ipc", false, "/dipnet.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "dipnet.ipc", true, `\\.\pipe\dipnet.ipc`},
		{"data", "dipnet.ipc", true, `\\.\pipe\dipnet.ipc`},
		{"data", `\\.\pipe\dipnet.ipc`, true, `\\.\pipe\dipnet.ipc`},
	}
