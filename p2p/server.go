...
// Package p2p implements the DipNet p2p network protocols.
package p2p
...
import (
	...
	"github.com/dipnetvn/dipnet-core/p2p/discover"
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // DipNet Node Record
