...
import (
	...
	"github.com/dipnetvn/dipnet-core/internal/jsre"
	"github.com/dipnetvn/dipnet-core/internal/jsre/deps"
	"github.com/dipnetvn/dipnet-core/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute DipNet requests through
...
// Welcome show summary of current DipNet instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the DipNet JavaScript console!\n\n"

	// Print some generic DipNet metadata
