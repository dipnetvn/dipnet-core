...
// invoked by the dipnet-core core at various points in the state transition.
//
// To create a tracer that can be invoked with DipNet, you need to register it using
// [github.com/dipnetvn/dipnet-core/eth/tracers.LiveDirectory.Register].
//
// See https://dipnet.dipnet.org/docs/developers/evm-tracing/live-tracing for a tutorial.
package tracing
