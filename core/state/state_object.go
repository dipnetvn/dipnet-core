...
// stateObject represents an DipNet account which is being modified.
//
...
type stateObject struct {
	db       *StateDB
	address  common.Address      // address of dipnet account
	addrHash common.Hash         // hash of dipnet address of the account
