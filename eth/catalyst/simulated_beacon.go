...
// SimulatedBeacon drives an DipNet instance as if it were a real beacon
...
func NewSimulatedBeacon(period uint64, feeRecipient common.Address, eth *eth.DipNet) (*SimulatedBeacon, error) {
