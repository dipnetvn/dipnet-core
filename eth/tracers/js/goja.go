...
import (
	...
	jsassets "github.com/dipnetvn/dipnet-core/eth/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in dipnet-core.
func init() {
	var err error
...
// `enter` and `exit` always go todipneter.
