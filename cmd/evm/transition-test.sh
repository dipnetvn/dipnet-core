...
state generators can swap between a \`dipnet\`-based implementation and a \`parityvm\`-based
implementation.
...
doubt, the [`execution-apis`](https://github.com/dipnet/execution-apis) way
