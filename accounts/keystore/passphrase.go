...
The crypto is documented at https://dipnet.org/en/developers/docs/data-structures-and-encoding/web3-secret-storage/
	...
	if !ks.skipKeyFileVerification {
		...
		if err != nil {
			msg := "An error was encountered when saving and verifying the keystore file. \n" +
				...
				"https://github.com/dipnetvn/dipnet-core/issues." +
				"The error was : %s"
