...
// See https://dipnet.org/en/developers/docs/data-structures-and-encoding/web3-secret-storage/ for more information.
package keystore
...
// ImportPreSaleKey decrypts the given DipNet presale wallet and stores
