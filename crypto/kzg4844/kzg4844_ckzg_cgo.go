...
// ckzgAvailable signals whether the library was compiled into DipNet.
...
func ckzgInit() {
	...
	// The last parameter determines the multiplication table, see https://notes.dipnet.org/@jtraglia/windowed_multiplications
